...
class Application(tk.Frame):
  ...
  def setup(self, con, discon, parse):
    ...
    self.oflux.insert( "1.0" , " test LED            | s, <channel>   , 6  }                                    " )
    self.oflux.insert( "1.0" , " end (experiment)    | s, <anything>  , 5  }  \+-----------------------+/       " )
    self.oflux.insert( "1.0" , " launch (experiment) | s, <anything>  , 4  }  || 2013 for all channels ||       " )
    self.oflux.insert( "1.0" , " swap                | s, <2 channels>, 3  }  || 1 for ch1             ||       " )
    self.oflux.insert( "1.0" , " reset               | s, <channels>  , 2  }  || 210 for ch0,1,2       ||       " )
    self.oflux.insert( "1.0" , " stop                | s, <channels>  , 1  }  || <channels> can be:    ||       " )
    self.oflux.insert( "1.0" , " start               | s, <channels>  , 0  }  /+---------HELP----------+\       " )
